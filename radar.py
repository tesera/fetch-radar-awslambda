...
def lambda_handler(event, context):
    ...
    t = parse(event['time'])
    return [process_site(site, t, bucket) for site in sites]

def process_site(site, t, bucket):
    print "Processing %(site)s" % locals()
    morning_urls = get_image_urls(site, t.year, t.month, t.day-1, '00', '00', 12)
    evening_urls = get_image_urls(site, t.year, t.month, t.day-1, '12', '00', 12)
